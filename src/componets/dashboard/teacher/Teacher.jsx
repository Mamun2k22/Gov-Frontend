        ...
        <div className="hidden sm:block">
          ...
          <ul class="bg-white shadow-[0_2px_8px_-1px_rgba(6,81,237,0.4)] p-1 space-x-4 w-max flex items-center rounded-lg mx-auto font-[sans-serif] mt-4">
            ...
            <li>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="fill-gray-400 w-3 -rotate-90 leading-none"
                viewBox="0 0 24 24"
              >
                <path
                  fill-rule="evenodd"
            ...
            <li class="text-gray-400 hover:bg-gray-100 px-4 py-2 rounded-lg text-sm font-bold cursor-pointer flex items-center">
              All Teachers
            </li>
          </ul>
        </div>
                ...
                <tbody className="divide-y divide-gray-300 ">
                  <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                    <td className=" px-5 py-3">
                      <div className="w-40 before:flex items-center gap-3">
                        <div className="data">
